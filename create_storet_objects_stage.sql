      ...
      execute immediate q'!insert /*+ append nologging */ into biological_result_temp (result_pk, activity_pk, station_pk, station_id, site_type, country_cd, state_cd, county_cd, huc_8, geom, 
          ...
          select /*+ parallel (4) */
                 ...
                 xml_helpers.biological_activity(xml_helpers.strip_bad(fa_biological_result.organization_id),
                                                 ...
                                                 xml_helpers.strip_bad(fa_biological_result.activity_start_date_time),
                                                 xml_helpers.strip_bad(fa_biological_result.act_start_time_zone),
                                                 xml_helpers.strip_bad(fa_biological_result.activity_stop_date_time),
                                                 ...
                                                 xml_helpers.strip_bad(fa_biological_result.horizontal_accuracy_measure), 
                                                 ...
                                                 xml_helpers.strip_bad(fa_biological_result.sampling_duration),
                                                 xml_helpers.strip_bad(fa_biological_result.place_in_series),
                                                 xml_helpers.strip_bad(fa_biological_result.reach_length),
                                                 xml_helpers.strip_bad(fa_biological_result.reach_width),
                                                 ...
                                                 xml_helpers.strip_bad(fa_biological_result.tow_net_mesh_size),
                                                 xml_helpers.strip_bad(fa_biological_result.boat_speed),
                                                 xml_helpers.strip_bad(fa_biological_result.toxicity_test_type),
                                                 xml_helpers.strip_bad(fa_biological_result.field_procedure_id),
                                                 xml_helpers.strip_bad(fa_biological_result.field_gear_id),
                                                 xml_helpers.strip_bad(fa_biological_result.field_prep_procedure_id),
                 ...
                 xml_helpers.biological_result(xml_helpers.strip_bad(fa_biological_result.result_value_text),
                                               ...
                                               xml_helpers.strip_bad(fa_biological_result.result_group_summary_ct_wt),
                                               ...
                                               xml_helpers.strip_bad(fa_biological_result.analysis_date_time),
                                               xml_helpers.strip_bad(fa_biological_result.analysis_time_zone),
                                               xml_helpers.strip_bad(fa_biological_result.analysis_end_date_time),
                                               xml_helpers.strip_bad(fa_biological_result.analysis_end_time_zone),
                                               xml_helpers.strip_bad(fa_biological_result.lab_remark),
                                               xml_helpers.strip_bad(fa_biological_result.all_result_detection_limit),
...
select * from (                                                                                       
          select /*+ parallel (4) */
                 ...
                 storetw_fa_station.organization_id,
                                      ...
                                      trim(fa_biological_result.trip_id) trip_id,
                                      fa_biological_result.replicate_number,
                                      fa_biological_result.activity_type,
                                      fa_biological_result.activity_medium,
                                      fa_biological_result.activity_start_date_time,
                                      fa_biological_result.act_start_time_zone,
                                      fa_biological_result.activity_stop_date_time,
                                      fa_biological_result.act_stop_time_zone,
                                      fa_biological_result.activity_depth,
                                      fa_biological_result.activity_depth_unit,
                                      fa_biological_result.activity_depth_ref_point,
                                      fa_biological_result.activity_upper_depth,
                                      fa_biological_result.upr_lwr_depth_unit,
                                      fa_biological_result.activity_lower_depth,
                                      fa_biological_result.project_id,
                                      fa_biological_result.activity_cond_org_text,
                                      fa_biological_result.activity_comment,
                                      trim(fa_biological_result.field_procedure_id) field_procedure_id,
                                      trim(fa_biological_result.field_gear_id) field_gear_id,
                                      fa_biological_result.result_value_text,
                           fa_biological_result.sample_fraction_type,
                           fa_biological_result.result_value,
                           fa_biological_result.result_unit,
                           fa_biological_result.result_meas_qual_code,
                           fa_biological_result.result_value_status,
                           fa_biological_result.statistic_type,
                           fa_biological_result.result_value_type,
                           fa_biological_result.weight_basis_type,
                           fa_biological_result.duration_basis,
                           fa_biological_result.temperature_basis_level,
                           fa_biological_result.particle_size,
                           fa_biological_result.precision,
                           fa_biological_result.result_comment,
                           fa_biological_result.result_depth_meas_value,
                           fa_biological_result.result_depth_meas_unit_code,
                           fa_biological_result.result_depth_alt_ref_pt_txt,
                           fa_biological_result.itis_number,
                           fa_biological_result.analytical_procedure_id,
                           fa_biological_result.analytical_procedure_source,
                           fa_biological_result.lab_samp_prp_method_id,
                           fa_biological_result.lab_name,
                           fa_biological_result.lab_remark
            from fa_biological_result
                 left join storetw_fa_station
                   on fa_biological_result.fk_station = storetw_fa_station.pk_isn
                 left join di_org
                 ...
                 left join di_geo_county
                   on storetw_fa_station.fk_geo_county = di_geo_county.pk_isn
              order by fa_biological_result.fk_station, fa_biological_result.activity_start_date_time, fa_biological_result.activity_id, fa_biological_result.pk_isn)
      insert /*+ append nologging */ into biological_result_temp (result_pk, activity_pk, station_pk, station_id, site_type, country_cd, state_cd, county_cd, huc_8, geom, 
                                                                                       activity_start_date, characteristic_name, characteristic_type, sample_media, organization_id,
                                                                                       organization_clob, activity_clob, result_clob) 
select * from (                                                                                       
          select /*+ parallel (4) */
                 ...
                 sample_media,
                 organization_id,
                 xml_helpers.organization(organization_id, organization_name) organization_clob,
                 xml_helpers.activity(organization_id,
                                      activity_id,
                                      trip_id,
                                      replicate_number,
                                      activity_type,
                 ...
                 null result_clob
            from junk
--              order by station_pk, activity_start_date_time, activity_id, result_pk
              );
commit;
