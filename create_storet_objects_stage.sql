   ...
   begin
      ...
      execute immediate q'!insert /*+ append nologging */ into biological_result_temp (result_pk, activity_pk, station_pk, station_id, site_type, country_cd, state_cd, county_cd, huc_8, geom, 
          ...
          select /*+ parallel (4) */
                 ...
                 xml_helpers.organization(fa_biological_result.organization_id, di_org.organization_name) organization_clob,
                 xml_helpers.activity(storetw_fa_station.organization_id,
                                      fa_biological_result.activity_id,
                                      trim(fa_biological_result.trip_id),
                                      ...
                                      fa_biological_result.station_id,
                                      fa_biological_result.activity_comment,
                                      trim(fa_biological_result.field_procedure_id),
                                      trim(fa_biological_result.field_gear_id)
                                     ) activity_clob,
                 null result_clob
